# Летово — биржа: документация и архив исходного ТЗ

## Актуальная документация

Верхнеуровневый обзор симуляции и план работ: [market-simulation.md](market-simulation.md).

Подробный технический дизайн находится в [`letovo-dev/letovo-all`](https://github.com/letovo-dev/letovo-all/blob/main/docs/superpowers/specs/2026-08-20-market-simulation-design.md). Новая production-реализация создаётся там же.

Существующий C++ в этом репозитории — ранний исторический прототип. Его не следует развивать, переписывать или переносить как основу новой системы. Старые проценты активности, типы ботов, ценовые плиты и использование LLM ниже не являются требованиями новой версии.

## Архив: исходное ТЗ

Материал ниже сохранён для истории проекта и восстановления исходного замысла. При любых расхождениях актуальная документация выше имеет приоритет.

Базовые наработки по устройству биржи в Летово

> Архивная пометка: прежнее утверждение о логической корректности существующих функций и необходимости переписать их на другом фреймворке отменено новым дизайном.
